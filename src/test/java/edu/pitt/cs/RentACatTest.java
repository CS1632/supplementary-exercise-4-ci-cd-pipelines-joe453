...
public class RentACatTest {
	...
	public void testCatAvailableFalseNumCats0() {
		// TODO
		assertFalse("The return value for r.catAvailable(2) was not false", r.catAvailable(2));
	}
	...
	public void testCatAvailableTrueNumCats3() {
		...
		assertTrue("The return value for testCatAvailableTrueNumCats3 was false", r.catAvailable(2));
	...
	public void testCatAvailableFalseNumCats3() {
		...
		assertFalse("r.catAvailable(2) returns true", r.catAvailable(2));
	}
	...
	public void testCatExistsFalseNumCats0() {
		// TODO
		assertFalse("r was empty, but still returned true", r.catExists(2));
	...
	public void testCatExistsTrueNumCats3() {
		...
		assertTrue("returned false, but there is a cat with id 2", r.catExists(2));
	}
